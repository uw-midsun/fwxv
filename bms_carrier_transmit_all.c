...
void can_transmit_all() {
  ...
  can_transmit_bps_heartbeat(&msg, NULL);
  ...
  can_transmit_battery_vt(&msg, NULL);
  ...
  can_transmit_battery_aggregate_vc(&msg, NULL);
