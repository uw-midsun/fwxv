...
SYSTEM_CAN_MESSAGE_MOTOR_CONTROLLER_MOTOR_CONTROLLER_VC = (
    30 << 5) + SYSTEM_CAN_DEVICE_MOTOR_CONTROLLER
...
SYSTEM_CAN_MESSAGE_MOTOR_CONTROLLER_PRECHARGE_COMPLETED = (
    14 << 5) + SYSTEM_CAN_DEVICE_MOTOR_CONTROLLER
...
def babydriver_babydriver(id, data0, data1, data2, data3, data4, data5, data6):
    data = pack(id, 8) + pack(data0, 8) + pack(data1, 8) + pack(data2, 8) + \
        pack(data3, 8) + pack(data4, 8) + pack(data5, 8) + pack(data6, 8)
...
def bms_carrier_battery_fan_state(fan_1, fan_2, fan_3, fan_4, fan_5, fan_6, fan_7, fan_8):
    data = pack(fan_1, 8) + pack(fan_2, 8) + pack(fan_3, 8) + pack(fan_4, 8) + \
        pack(fan_5, 8) + pack(fan_6, 8) + pack(fan_7, 8) + pack(fan_8, 8)
...
def centre_console_drive_output(target_velocity, drive_state,
                                cruise_control, regen_braking, precharge):
    data = pack(target_velocity, 32) + pack(drive_state, 8) + \
        pack(cruise_control, 8) + pack(regen_braking, 8) + pack(precharge, 8)
...
def motor_controller_mc_status(limit_bitset_l, error_bitset_l, limit_bitset_r,
                               error_bitset_r, board_fault_bitset, overtemp_bitset, precharge_status):
    data = pack(limit_bitset_l,
                8) + pack(error_bitset_l,
                          8) + pack(limit_bitset_r,
                                    8) + pack(error_bitset_r,
                                              8) + pack(board_fault_bitset,
                                                        8) + pack(overtemp_bitset,
                                                                  8) + pack(precharge_status,
                                                                            8)
...
def power_select_power_select_aux_measurements(
...
def power_select_power_select_dcdc_measurements(
...
def solar_sense_thermal_status(overtemp, fullspeed, fan_fail, temp_1, temp_2):
    data = pack(overtemp, 8) + pack(fullspeed, 8) + \
        pack(fan_fail, 8) + pack(temp_1, 16) + pack(temp_2, 16)
