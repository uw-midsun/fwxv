...
def bms_carrier_battery_fan_state(fan_1, fan_2, fan_3, fan_4, fan_5, fan_6, fan_7, fan_8):
    data =pack(fan_1, 8) + pack(fan_2, 8) + pack(fan_3, 8) + pack(fan_4, 8) + pack(fan_5, 8) + pack(fan_6, 8) + pack(fan_7, 8) + pack(fan_8, 8)
...
def can_debug_test_debug(operation, operandA, operandB, operandC):
    data =pack(operation, 8) + pack(operandA, 8) + pack(operandB, 8) + pack(operandC, 8)
...
def centre_console_drive_output(target_velocity, drive_state, cruise_control, regen_braking, precharge):
    data =pack(target_velocity, 32) + pack(drive_state, 8) + pack(cruise_control, 8) + pack(regen_braking, 8) + pack(precharge, 8)
...
def motor_controller_motor_controller_vc(mc_voltage_l, mc_current_l, mc_voltage_r, mc_current_r):
    data =pack(mc_voltage_l, 16) + pack(mc_current_l, 16) + pack(mc_voltage_r, 16) + pack(mc_current_r, 16)
...
def motor_controller_motor_sink_temps(motor_temp_l, heatsink_temp_l, motor_temp_r, heatsink_temp_r):
    data =pack(motor_temp_l, 16) + pack(heatsink_temp_l, 16) + pack(motor_temp_r, 16) + pack(heatsink_temp_r, 16)
...
def motor_controller_mc_status(limit_bitset_l, error_bitset_l, limit_bitset_r, error_bitset_r, board_fault_bitset, overtemp_bitset, precharge_status):
    data =pack(limit_bitset_l, 8) + pack(error_bitset_l, 8) + pack(limit_bitset_r, 8) + pack(error_bitset_r, 8) + pack(board_fault_bitset, 8) + pack(overtemp_bitset, 8) + pack(precharge_status, 8)
...
def power_select_power_select_aux_measurements(aux_voltage, aux_current, aux_temp, power_supply_current):
    data =pack(aux_voltage, 16) + pack(aux_current, 16) + pack(aux_temp, 16) + pack(power_supply_current, 16)
...
def power_select_power_select_dcdc_measurements(dcdc_voltage, dcdc_current, dcdc_temp, power_supply_voltage):
    data =pack(dcdc_voltage, 16) + pack(dcdc_current, 16) + pack(dcdc_temp, 16) + pack(power_supply_voltage, 16)
...
def solar_sense_mppt_1(current, voltage, pwm, status):
    data =pack(current, 16) + pack(voltage, 16) + pack(pwm, 16) + pack(status, 16)
...
def solar_sense_current_sense(current, voltage, relay_status):
    data =pack(current, 16) + pack(voltage, 16) + pack(relay_status, 8)
...
def solar_sense_thermal_status(overtemp, fullspeed, fan_fail, temp_1, temp_2):
    data =pack(overtemp, 8) + pack(fullspeed, 8) + pack(fan_fail, 8) + pack(temp_1, 16) + pack(temp_2, 16)
    return f"{SYSTEM_CAN_MESSAGE_SOLAR_SENSE_THERMAL_STATUS:3>x}#{data}"

def solar_sense_thermal_temps(temp_3, temp_4, temp_5, temp_6):
    data =pack(temp_3, 16) + pack(temp_4, 16) + pack(temp_5, 16) + pack(temp_6, 16)
