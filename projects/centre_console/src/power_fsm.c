...
static bool s_power_transitions[NUM_POWER_STATES][NUM_POWER_STATES] = {
  ...
  TRANSITION(POWER_FSM_STATE_AUX, POWER_FSM_SEND_PD_BMS), // possible removal
  ...
  TRANSITION(POWER_FSM_TURN_ON_EVERYTHING, POWER_FSM_POWER_MAIN_COMPLETE), // possible removal
