...
void cc_displays_update(void) {
  static const GpioAddress cc_displays[] = { GPIO1,  GPIO2,  GPIO3,  GPIO4,  GPIO5,  GPIO6,
  ...
  SegDisplay cc_display = { GPIO1, GPIO2, GPIO3, GPIO4, GPIO5, GPIO6, GPIO7, GPIO8 };
  SegDisplay speed_display = { GPIO9, GPIO10, GPIO11, GPIO12, GPIO13, GPIO14, GPIO15, GPIO16 };
  SegDisplay batt_perc_display = { GPIO17, GPIO18, GPIO19, GPIO20, GPIO21, GPIO22, GPIO23, GPIO24 };
