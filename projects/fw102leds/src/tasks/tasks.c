...
//    gpio_it_register_interrupt(&button, &s_interrupt_settings, INTERRUPT_EDGE_RISING, prv_my_gpio_callback, 
//                               &LEDS[0]);
//    // gpio_it_register_interrupt(&button, &s_interrupt_settings, INTERRUPT_EDGE_RISING, prv_my_gpio_callback,
//    //                            &LEDS[1]);
// }
...
int main() {
   ...
   prv_init_gpio_pins();
   gpio_it_register_interrupt(&button, &s_interrupt_settings, INTERRUPT_EDGE_RISING, prv_my_gpio_callback, &LEDS[0]);
