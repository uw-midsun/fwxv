...
db = cantools.database.load_file('system_can.dbc') #change the file path to (can/tools/system_can.dbc)
...
for y in range(3):
    for x in range(3):
        Box = tk.Canvas(root, width=137, height=50, bg='#000000', highlightbackground='white', highlightthickness=BorderThickness).place(x=34+(x*137), y=40+(y*50))
...
for y in range(3):
    Box = tk.Canvas(root, width=34, height=50, bg='#000000', highlightbackground='white', highlightthickness=BorderThickness).place(x=0, y=40+(y*50))
...
for x in range (2):
    Box = tk.Canvas(root, width=223, height=50, bg='#000000', highlightbackground='white', highlightthickness=BorderThickness).place(x=0+(x*223), y=190)
...
def redBox(message, num):
    ...
    if (listCount > 2):
        listCount = 0
    RedBox = tk.Canvas(root, width=357, height=40, bg=red, highlightthickness=0).place(x=448, y=List[redlistCount])
    tk.Label(RedBox, text=message, font='Montserrat 10', bg =red, fg='black').place(x=450, y=(List[redlistCount]))
    tk.Label(RedBox, text=num, font='Montserrat 10', bg=red, fg='black').place(x=743, y=(List[redlistCount]))
    redlistCount += 1
...
def orangeBox(message, num):
    ...
    if (listCount > 7):
        listCount = 0
    OrangeBox = tk.Canvas(root, width=357, height=40, bg=orange, highlightthickness=0).place(x=448, y=List[listCount+3])
    tk.Label(OrangeBox, text=message, font='Montserrat 10', bg=orange, fg='black').place(x=450, y=(List[listCount+3]))
    tk.Label(OrangeBox, text=num, font='Montserrat 10', bg=orange, fg='black').place(x=743, y=(List[listCount+3]))
    listCount += 1
...
def yellowBox(message, num):
    ...
    if (listCount > 7):
        listCount = 0
    YellowBox = tk.Canvas(root, width=357, height=40, bg=yellow, highlightthickness=0).place(x=448, y=List[listCount+3])
    tk.Label(YellowBox, text=message, font='Montserrat 10', bg=yellow, fg='black').place(x=450, y=(List[listCount+3]))
    tk.Label(YellowBox, text=num, font='Montserrat 10', bg=yellow, fg='black').place(x=743, y=(List[listCount+3]))
    listCount += 1
...
def AFE1FullUpdate():
    ...
    if None not in AFE_Data[0]["Voltages"]:
        ...
        tk.Label(Box, text=AFE1MaxTemp, font='Montserrat 8', bg='#000000', fg='white').place(x=47, y=60)
        tk.Label(Box, text=AFE1Max, font='Montserrat 8', bg='#000000', fg='white').place(x=47, y=114)
        tk.Label(Box, text=AFE1Min, font='Montserrat 8', bg='#000000', fg='white').place(x=47, y=161)
...
def AFE2FullUpdate():
    ...
    if None not in AFE_Data[1]["Voltages"]:
        ...
        tk.Label(Box, text=AFE2MaxTemp, font='Montserrat 8', bg='#000000', fg='white').place(x=184, y=60)
        tk.Label(Box, text=AFE2Max, font='Montserrat 8', bg='#000000', fg='white').place(x=184, y=114)
        tk.Label(Box, text=AFE2Min, font='Montserrat 8', bg='#000000', fg='white').place(x=184, y=161)
...
def AFE3FullUpdate():
    ...
    if None not in AFE_Data[2]["Voltages"]:
        ...
        tk.Label(Box, text=AFE3MaxTemp, font='Montserrat 8', bg='#000000', fg='white').place(x=323, y=60)
        tk.Label(Box, text=AFE3Max, font='Montserrat 8', bg='#000000', fg='white').place(x=323, y=114)
        tk.Label(Box, text=AFE3Min, font='Montserrat 8', bg='#000000', fg='white').place(x=323, y=161)
...
def handle_message(msg):
    ...
    if (GUICount%10 == 0):
        ...
        for x in range(10):
            BlackBox = tk.Canvas(root, width=357, height=40, bg='#000000', highlightthickness=0).place(x=448, y=List[x])
    ...
    try:
        ...
        if msg.arbitration_id in DISPLAY_MSG_AFES:
            ...
            AFE_Data[afe_index]["Voltages"][3*decoded_message["id"]+1] = decoded_message["v2"]/1000
            AFE_Data[afe_index]["Voltages"][3*decoded_message["id"]+2] = decoded_message["v3"]/1000
            AFE1FullUpdate()
            AFE2FullUpdate()
            AFE3FullUpdate()
        ...
        if msg.arbitration_id in DISPLAY_MSG_DICT_CURRENT_SENSE:
            ...
            tk.Label(Box, text=((decoded_message['voltage']/1000),  'A'), font='Montserrat 16', width=6, bg='#000000', fg='white').place(x=709, y=18)
