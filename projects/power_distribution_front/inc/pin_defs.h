...
#define FRONT_PIN_CENTRE_CONSOLE_EN \
  { PD_PCA9555_I2C_ADDRESS_1, PCA9539R_PIN_IO1_4 }

#define FRONT_PIN_STEERING_EN \
  { PD_PCA9555_I2C_ADDRESS_0, PCA9539R_PIN_IO0_2 }

#define FRONT_PIN_PEDAL_EN \
  { PD_PCA9555_I2C_ADDRESS_0, PCA9539R_PIN_IO0_4 }

#define FRONT_PIN_DAYTIME_RUNNING_LIGHTS_EN \
  { PD_PCA9555_I2C_ADDRESS_1, PCA9539R_PIN_IO1_3 }

#define FRONT_PIN_FRONT_LEFT_TURN_LIGHT_EN \
  { PD_PCA9555_I2C_ADDRESS_1, PCA9539R_PIN_IO1_0 }

#define FRONT_PIN_FRONT_RIGHT_TURN_LIGHT_EN \
  { PD_PCA9555_I2C_ADDRESS_1, PCA9539R_PIN_IO1_2 }

#define FRONT_PIN_MAIN_PI_CAMERA_DISPLAY_EN \
  { PD_PCA9555_I2C_ADDRESS_0, PCA9539R_PIN_IO1_0 }

// Select Pins
#define FRONT_PIN_CENTRE_CONSOLE_REAR_DISPLAY_DSEL \
  { PD_PCA9555_I2C_ADDRESS_1, PCA9539R_PIN_IO1_5 }

#define FRONT_PIN_PEDAL_STEERING_DSEL \
  { PD_PCA9555_I2C_ADDRESS_0, PCA9539R_PIN_IO0_3 }

#define FRONT_PIN_FRONT_LEFT_RIGHT_TURN_LIGHT_DSEL \
  { PD_PCA9555_I2C_ADDRESS_1, PCA9539R_PIN_IO1_1 }
...
#define REAR_PIN_MCI_EN \
  { PD_PCA9555_I2C_ADDRESS_0, PCA9539R_PIN_IO0_6 }

#define REAR_PIN_BMS_EN \
  { PD_PCA9555_I2C_ADDRESS_0, PCA9539R_PIN_IO0_0 }

#define REAR_PIN_SOLAR_SENSE_EN \
  { PD_PCA9555_I2C_ADDRESS_0, PCA9539R_PIN_IO0_5 }

#define REAR_PIN_FAN_1_EN \
  { PD_PCA9555_I2C_ADDRESS_1, PCA9539R_PIN_IO1_7 }

#define REAR_PIN_STROBE_LIGHT_EN \
  { PD_PCA9555_I2C_ADDRESS_1, PCA9539R_PIN_IO0_7 }
...
#define REAR_PIN_STROBE_LIGHT_DSEL \
  { PD_PCA9555_I2C_ADDRESS_1, PCA9539R_PIN_IO0_2 }
