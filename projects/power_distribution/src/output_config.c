...
static OutputGroupDef s_output_group_power_off = {
  .num_outputs = 7, .outputs = { CENTER_CONSOLE, BMS_DCDC, BMS_AUX, PEDAL, STEERING, REAR_CAM_LCD, SPARE_5V_AUX }
};
...
static OutputGroupDef s_output_group_power_drive = { .num_outputs = 10,
                                                     .outputs = { CENTER_CONSOLE, BMS_DCDC, BMS_AUX,
                                                                  ...
                                                                  DRIVER_FAN, REAR_CAM_LCD, SPARE_5V_AUX } };

static OutputGroupDef s_output_group_power_fault = {
  .num_outputs = 7, .outputs = { CENTER_CONSOLE, BMS_DCDC, PEDAL, STEERING, BPS_LIGHT, REAR_CAM_LCD, SPARE_5V_AUX }
};
