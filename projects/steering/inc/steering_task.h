...
#define VOLTAGE_TOLERANCE_MV 70
// turn signal voltages
#define TURN_LEFT_SIGNAL_VOLTAGE_MV 1927
#define TURN_RIGHT_SIGNAL_VOLTAGE_MV 1089
#define NEUTRAL_SIGNAL_VOLTAGE_MV 2993
// cruise control voltages
#define CRUISE_CONTROl_STALK_SPEED_INCREASE_VOLTAGE_MV 1491
#define CRUISE_CONTROl_STALK_SPEED_DECREASE_VOLTAGE_MV 711
