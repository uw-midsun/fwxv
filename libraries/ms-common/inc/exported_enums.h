...
typedef enum {
  ...
  EE_PD_STATUS_FAULT_BITSET_AUX_OVERCURRENT_BIT,
  EE_PD_STATUS_FAULT_BITSET_DCDC_OVERCURRENT_BIT,
  EE_PD_STATUS_FAULT_BITSET_AUX_OVERTEMP_BIT,
  EE_PD_STATUS_FAULT_BITSET_DCDC_OVERTEMP_BIT,
...
#define EE_PD_STATUS_FAULT_BITSET_AUX_OVERCURRENT_MASK \
  (1 << EE_PD_STATUS_FAULT_BITSET_AUX_OVERCURRENT_BIT)

#define EE_PD_STATUS_FAULT_BITSET_DCDC_OVERCURRENT_MASK \
  (1 << EE_PD_STATUS_FAULT_BITSET_DCDC_OVERCURRENT_BIT)

#define EE_PD_STATUS_FAULT_BITSET_AUX_OVERTEMP_MASK \
  (1 << EE_PD_STATUS_FAULT_BITSET_AUX_OVERTEMP_BIT)

#define EE_PD_STATUS_FAULT_BITSET_DCDC_OVERTEMP_MASK \
  (1 << EE_PD_STATUS_FAULT_BITSET_DCDC_OVERTEMP_BIT)
